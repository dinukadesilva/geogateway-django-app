    ...
    export default {
        ...
        methods: {
            ...
            getCSV(entry, latlon){
              ...
              axios.get('http://192.168.1.4:8000/geogateway_django_app/UAVSAR_csv/', {
                  params: {
            ...
            extendEntry(entry){
                ...
                if(!entry.extended) {
                    ...
                    var testURI =  'http://192.168.1.4:8000/geogateway_django_app/UAVSAR_test/'
            ...
            pointQuery(lat, lon){
                if(this.overview) {
                    ...
                    var baseURI = 'http://192.168.1.4:8000/geogateway_django_app/UAVSAR_geom/'
                    axios.get(baseURI, {
                        params: {
                            //
                            "type": "point",
                        ...
                        for (var i = 0; i < entries.length; i++) {
                            var baseURI = 'http://192.168.1.4:8000/geogateway_django_app/UAVSAR_KML/'
                            axios.get(baseURI, {
                                params: {
                                    //
